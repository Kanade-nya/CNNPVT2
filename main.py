...
# model_ft = pvt_tiny(pretrained=False)
model_ft = torch.load('./pvtmodel.pth')
# print(model_ft)
...
def val(model, device, test_loader):
    ...
    with torch.no_grad():
        ...
        torch.save(model_ft, 'pvtmodel.pth')
        if acc > ACC:
